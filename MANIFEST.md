...
**400** nodes · **3** axioms · **0** on the frontier

✅ World is closed — no missing prerequisites.

## 🌳 Parent (root) nodes — top-level, required by nothing (135)
