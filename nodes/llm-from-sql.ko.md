...
임베딩할 수 있다. 그리고 검색-증강 생성(retrieval-augmented generation)의 *검색(retrieval)*
...
검색-증강 생성이 사용하는 의미에서 언어 모델은 텍스트
...
- **RAG가 한 곳에.** 검색-증강 생성은 *관련성이 가장 높은
  ...
  검색-증강 생성이 기술하는 루프 전체가, 외부 오케스트레이터
  없이.
...
검색-증강 생성이 단일 [[sql]] 질의로 표현된다. 검색-후-생성
